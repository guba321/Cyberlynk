	...
	const processSteps = [
		{
			...
			description: "A list of the most critical risks in API security, widely used in API assessments.",
			icon: Users,
		...
		},
		{
			...
			description: "Security controls that can be applied to APIs, especially in enterprise systems.",
			icon: Layout,
			imagePath: "./images/process2.png"
		},
		{
			number: "03",
			title: "OpenAPI/Swagger Security Guidelines",
			description: "A framework for defining and enforcing security requirements in API specifications.",
			icon: Code,
