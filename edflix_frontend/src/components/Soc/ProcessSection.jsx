	...
	const processSteps = [
		{
			...
			description: "The practice of collecting, analyzing, and applying intelligence on adversaries, attack vectors, and emerging threats to strengthen proactive defense strategies within the SOC.",
			icon: Users,
		...
		},
		{
			...
			description: "A structured process where SOC analysts actively search for hidden threats, undetected intrusions, or malicious activities within the environment before automated alerts are triggered.",
			icon: Layout,
		...
		},
		{
			...
			description: "Focused on detecting and investigating malicious emails, phishing attempts, and business email compromise (BEC) to prevent initial attack vectors that target end-users.",
			icon: Code,
		...
		},
		{
			...
			description: "Continuous monitoring and response framework that leverages EDR solutions to detect, analyze, and remediate endpoint-based threats in real time.",
			icon: Shield,
