	...
	const processSteps = [
		{
			...
			description: "Practical guide for penetration testers and developers to assess mobile app security.",
			icon: Users,
		...
		},
		{
			...
			description: "Establishes baseline requirements for secure mobile app development and testing.",
			icon: Layout,
			imagePath: "./images/process2.png"
		},
		{
			number: "03",
			title: "NIST SP 800-163 (Vetting the Security of Mobile Applications)",
			description: "Guidance for evaluating mobile applications for enterprise use and government adoption.",
			icon: Code,
